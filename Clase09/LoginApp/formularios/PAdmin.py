...
class PAdmin(tk.Tk):
    ...
    def listar_usuarios(self):
        ...
        with open("D:\_EMPRESARIAL\_TECNAR\CLASES\PROGRAMACION\REPOPROG2\Clase09\LoginApp\db_users.json", "r", encoding='utf-8') as self.file:
                        ...
                        if self.tipo_action == "Actualizar":
                            ...
                            for usuarios in self.db_users["users"]:
                                if usuarios["id"] == self.tablausuarios.item(self.tablausuarios.selection())["text"]:
                                    ...
                                    with open('D:\_EMPRESARIAL\_TECNAR\CLASES\PROGRAMACION\REPOPROG2\Clase09\LoginApp\db_users.json', 'w') as jf: 
