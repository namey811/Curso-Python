...
class FormularioMaestroDesign(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.logo = util_img.leer_imagen("D:\_EMPRESARIAL\_TECNAR\CLASES\PROGRAMACION\REPOPROG2\Clase08\FinalApp\imagenes\logo.png", (560, 136))
        self.perfil = util_img.leer_imagen("D:\_EMPRESARIAL\_TECNAR\CLASES\PROGRAMACION\REPOPROG2\Clase08\FinalApp\imagenes\Perfil.png", (100, 100))
        self.config_window()
        self.paneles()
    ...
    def controles_barra_superior(self):
        ...
        # Etiqueta de título
        self.labelTitulo = tk.Label(self.barra_superior, text="Unitecnar")
        ...
        self.labelTitulo = tk.Label(
            self.barra_superior, text="ivan.narvaez@unitecnar.edu.co")
        self.labelTitulo.config(fg="#fff", font=(
    ...
    def controles_menu_lateral(self):
        ...
        buttons_info = [
            ...
            ("Imagen", "\uf03e", self.buttonPicture),
            ("Informacion", "\uf129", self.buttonInfo),
            ("Configuracion", "\uf013", self.buttonSettings)
        ]
